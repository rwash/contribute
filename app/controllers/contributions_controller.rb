...
class ContributionsController < ApplicationController
	...
	def create
		...
		redirect_to Amazon::FPS::MultiTokenRequest.url(@contribution.amount, @project.name, self.request.host_with_port + '/contributions/save', @project.payment_account_id)
	end
