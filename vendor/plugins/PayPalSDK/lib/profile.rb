...
@@headers = {"X-PAYPAL-SERVICE-VERSION" => "1.0.0","X-PAYPAL-SECURITY-USERID" => "rockwe_1330392414_biz_api1.msu.edu","X-PAYPAL-SECURITY-PASSWORD" =>"1330392446", "X-PAYPAL-SECURITY-SIGNATURE" => "AGohBnTM8iO4uyDgdtLpL4YKqanOAgYaqzhG-JNcvpvnyErz2NbI56sp", "X-PAYPAL-APPLICATION-ID" => "APP-80W284485P519543T","X-PAYPAL-DEVICE-IPADDRESS"=>"127.0.0.1" , "X-PAYPAL-REQUEST-DATA-FORMAT" => "NV" , "X-PAYPAL-RESPONSE-DATA-FORMAT" => "NV"}
...
@@client_details ={"ipAddress"=>"127.0.0.1", "deviceId"=>"mydevice", "applicationId"=>"CONTRIBUTEMSU"}
