...
class AuthorizationRequest
	...
	def self.get_cbui_params(amount, pipeline, caller_reference, payment_reason, host_with_port)
		params = {}
		...
		puts 'MAHHHH URL', params["returnUrl"]	
		return params
	end
	...
	def self.url(host_with_port)
		...
		params = get_cbui_params("50", "SingleUse", rand(9999999), "Testing Contribute", host_with_port)
