...
module Amazon
  module FPS
    ...
    class PayRequest < BaseFpsRequest
      ...
      # If an error returns, the beginning element will be 'Response' rather than 'PayResonse'.
      # Amazon is a royal pain in the ass.
      # This applies to all other fps strip_response calls as well.
