...
describe Project do
  ...
  describe 'funding goal validations' do
    ...
    it { should validate_numericality_of(:funding_goal).with_message(/must be at least \$5/) }
    ...
    it { should_not allow_value(4).for(:funding_goal).with_message(/must be at least \$5/) }
